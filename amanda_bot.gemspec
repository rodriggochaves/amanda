...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "dot_env", "~> 0.0.3"
  spec.add_development_dependency "octokit", "~> 4.7"
  spec.add_development_dependency "git_diff_parser", "~> 3.1.0"
  spec.add_development_dependency "rugged", "~> 0.26.0"
